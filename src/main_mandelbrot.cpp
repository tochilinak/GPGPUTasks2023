...
//    float sizeX = 2.0f;
    ...
    context.activate();
    {
        ...
        unsigned int workSizeX = (width + workGroupSizeX - 1) / workGroupSizeX * workGroupSizeX;
        unsigned int workSizeY = (height + workGroupSizeY - 1) / workGroupSizeY * workGroupSizeY;
        auto workSize = gpu::WorkSize(workGroupSizeX, workGroupSizeY, workSizeX, workSizeY);
